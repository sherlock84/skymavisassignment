...
const MyWalletPage: NextPage = () => {
  const totalAmount = React.useMemo(() => assets.reduce((sum, asset) => sum + asset.nativeAmount, 0), [assets]);
  return (
    <div className="flex flex-col items-stretch h-full my-5 gap-5">
      ...
      <WalletOverview currency="VND" locale="en-US" totalAmount={totalAmount} walletNumber="7300 3777 3888 3334" />
